...
export default function Sidebar({
  mode, onModeChange, isoBand, onIsoBandChange, onSelectMetric, flowSrc, onFlowSrcChange, flowHour, onFlowHourChange, flowDir, onFlowDirChange,
}: {
  mode: MapMode;
  ...
  flowHour: number;
  onFlowHourChange: (h: number) => void;
  flowDir: "in" | "out";
  onFlowDirChange: (d: "in" | "out") => void;
}) {
